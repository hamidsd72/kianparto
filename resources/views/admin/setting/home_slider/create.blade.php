  ...
  <div class="row mt-5">
    <div class="col-xl-12 col-md-12 col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          {{ Form::open(array('route' => 'admin.home-slider.store', 'method' => 'POST','id'=>'form_req','files'=>true)) }}
          <div class="row">
            <nav class="w-100">
                    ...
                    <div class="row">
                      ...
                      {{-- <div class="col-md-4">
                        <div class="form-group">
                          ...
                          {{Form::text('title1_'.$lang->lang,null, array('class' => 'form-control'))}}
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                      ...
                      <div class="col-md-12 ">
                        <div class="form-group">
                          ...
                          {{Form::textarea('text_'.$lang->lang,null, array('class' => 'form-control '.$lang->align=='ltr'?'textarea_ltr':'textarea_rtl'))}}
                        </div>
                      </div>
                      {{-- <div class="col-md-6">
                        <div class="form-group">
