    ...
    <div class="row mt-5">
        <div class="col-xl-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{ Form::open(array('route' => 'admin.article.store', 'method' => 'POST','id'=>'form_req','files'=>true)) }}
                    <div class="row">
                        <nav class="w-100">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                {{Form::text('author', auth()->user()->name, array('class' => 'form-control','required'))}}
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            {{Form::label('short_text', 'خلاصه خبر *')}}
                                            <div class="form-group form-group-post">
                                                {{Form::text('short_text', null, array('class' => 'form-control','required'))}}
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('author_'.$lang->lang, auth()->user()->name, array('class' => 'form-control'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                {{Form::label('short_text_'.$lang->lang, 'خلاصه خبر *')}}
                                                <div class="form-group form-group-post">
                                                    {{Form::text('short_text_'.$lang->lang, read_lang($item,'short_text',$lang->lang), array('class' => 'form-control'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('title_page_'.$lang->lang, null, array('class' => 'form-control'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    {{Form::label('key_word_'.$lang->lang, ' کلمات کلیدی(کلمات را وارد کنید و اینتر بزنید تا ثبت شود)')}}
                                                    {{Form::text('key_word_'.$lang->lang, null, array('class' => 'form-control key_word'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    {{Form::label('description_'.$lang->lang, ' توضیحات(سئو)')}}
                                                    {{Form::text('description_'.$lang->lang, null, array('class' => 'form-control'))}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{Form::file('photo', array('class' => 'dropify','data-height'=>'180','accept' => '.jpg,.jpeg','required'))}}
                            </div>
                        ...
                        <div class="col-md-12 text-left">
                            <hr/>
                            {{Form::submit('افزودن',array('class'=>'btn btn-primary  article_submit'))}}
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
