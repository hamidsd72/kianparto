            ...
            <div class="card">
                <div class="card-header  border-0">
                    <h4 class="w-100">
                        ...
                        <a href="{{route('admin.operation-tab.create')}}" class="btn btn-primary float-left">افزودن</a>
                        @endcan
                    </h4>
                </div>
                        ...
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="tbl_3" style="width:100%">
                            ...
                            @foreach($items as $key=>$item)
                                <tr>
                                    ...
                                    <td>
                                        @php echo mb_substr($item->title1,0,30) ;@endphp ...
                                    </td>
                                    @canany(['operation_cat_edit','operation_cat_delete'])
                                        <td>
                                            <div class="d-flex">
                                                @can('operation_cat_edit')
                                                    <a href="{{route('admin.operation-tab.edit',$item->id)}}"
                                                       class="action-btns1">
                                                ...
                                                @endcan
                                                    ...
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['admin.operation-tab.destroy', $item->id] ]) !!}
