            ...
            <div class="card">
                <div class="card-header  border-0">
                    <h4 class="w-100">
                        ...
                        <a href="{{route('admin.operation-top-content.specification.create',[$type, $id])}}" class="btn btn-primary float-left">افزودن</a>
                        @endcan
                    </h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="tbl_3" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">محتوا</th>
                            ...
                            @foreach($items as $key=>$item)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>
                                       {{$item->content?$item->content->title1:'___________'}}
                                    </td>
                                    <td>
                                       {{$item->title}}
                                    </td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                @can('operation_cat_edit')
                                                    <a href="{{route('admin.operation-top-content.specification.edit',$item->id)}}"
                                                       class="action-btns1">
                                                ...
                                                @can('operation_cat_delete')
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['admin.operation-top-content.specification.destroy', $item->id] ]) !!}
