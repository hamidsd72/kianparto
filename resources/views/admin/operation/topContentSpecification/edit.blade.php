  ...
  <div class="row mt-5">
    <div class="col-xl-12 col-md-12 col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          {{ Form::model($item,array('route' => array('admin.operation-top-content.specification.update',$item->id),'id'=>'form_req', 'method' => 'PATCH','files'=>true)) }}
                ...
                <div class="tab-pane fade {{$lang->align=='ltr'?'ltr_tab':''}}" id="nav-{{$lang->lang}}" role="tabpanel"
                  ...
                  <div class="container-fluid">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          {{Form::label('title_'.$lang->lang, ' عنوان اصلی *')}}
                          {{Form::text('title_'.$lang->lang, read_lang($item,'title',$lang->lang), array('class' => 'form-control  ','required'))}}
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          {{Form::label('text_'.$lang->lang, '  متن عنوان اصلی ')}}
                          {{Form::textarea('text_'.$lang->lang,read_lang($item,'text',$lang->lang), array('class' => 'form-control'))}}
                        </div>
                      </div>
                    </div>
                  </div>
