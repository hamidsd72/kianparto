            ...
            <div class="card">
                <div class="card-header  border-0">
                    <h4 class="w-100">
                        ...
                        <a href="{{route('admin.operation-cat.create')}}" class="btn btn-primary float-left">افزودن</a>
                        @endcan
                    </h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="tbl_3" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">تعداد زیر دسته</th>
                            ...
                            @foreach($items as $key=>$item)
                                <tr>
                                    ...
                                    <td style="width:20%">
{{--                                       <a href="{{route('front.filter.operation.id',[app()->getLocale(),$item->slug])}}" target="_blank" dir="ltr">--}}
                                           مشاهده صفحه
                                       </a>
                                    </td>
                                    @canany(['operation_cat_edit','operation_cat_delete'])
                                        <td>
                                            <div class="d-flex">
                                                @can('operation_cat_edit')
                                                    <a href="{{route('admin.operation-cat.edit',$item->id)}}"
                                                       class="action-btns1">
                                                ...
                                                @endcan
                                                    ...
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['admin.operation-cat.destroy', $item->id] ]) !!}
                                ...
                                @foreach($item->children as $key=>$child)
                                    ...
                                    <tr style="background-color: darkgray;">
                                        <td>زیر دسته{{$key+1}}</td>
                                        <td>
                                            {{$child->title}}
                                        </td>
                                        <td>
                                            @if($child->photo)
                                                <img src="{{url($child->photo->path)}}" style="height: 100px">
                                            @else
                                                بدون تصویر
                                            @endif
                                        </td>
                                        ...
                                        <td style="width:20%">
{{--                                            <a href="{{route('front.filter.operation.id',[app()->getLocale(),$child->slug])}}" target="_blank" dir="ltr">--}}
                                                مشاهده صفحه
{{--                                                     {{route('front.filter.operation.id',[app()->getLocale(),$child->slug])}}--}}
                                            </a>
                                        </td>
                                        @canany(['operation_cat_edit','operation_cat_delete'])
                                            <td>
                                                <div class="d-flex">
                                                    @can('operation_cat_edit')
                                                        <a href="{{route('admin.operation-cat.edit',$child->id)}}"
                                                           class="action-btns1">
                                                            <i class="feather feather-edit-2  text-success"
                                                               data-toggle="tooltip" data-placement="top"
                                                               title="ویرایش"></i>
                                                    ...
                                                    @endcan
                                                    @can('operation_cat_delete')
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['admin.operation-cat.destroy', $child->id] ]) !!}
                                                        <button class="action-btns1" data-toggle="tooltip"
                                                                data-placement="top" title="حذف"
                                                                onclick="return confirm('برای حذف مطمئن هستید؟')">
                                                            <i class="feather feather-trash-2 text-danger"></i>
