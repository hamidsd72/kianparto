  ...
  <div class="row mt-5">
    <div class="col-xl-12 col-md-12 col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          {{ Form::open(array('route' => 'admin.operation-topContent.store', 'method' => 'POST','id'=>'form_req','files'=>true)) }}
          <div class="row">
            <nav class="w-100">
                  ...
                  <div class="row">
                    ...
                    {{-- <div class="col-md-12">
                      <div class="form-group">
                        ...
                        {{Form::text('title2', null, array('class' => 'form-control text-left d-ltr'))}}
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                ...
                <div class="tab-pane fade {{$lang->align=='ltr'?'ltr_tab':''}}" id="nav-{{$lang->lang}}" role="tabpanel" aria-labelledby="nav-{{$lang->lang}}-tab">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          {{Form::label('status__'.$lang->lang, 'وضعیت  *')}}
                          {{ Form::select('status__'.$lang->lang, ['pending'=>'عدم انتشار','active'=>'انتشار'], null, array('class' => 'form-control select2-show-search custom-select','required')) }}
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          {{Form::label('special_'.$lang->lang, 'نمایش در محصولات ویژه  *')}}
                          {{ Form::select('special_'.$lang->lang, ['pending'=>'عدم نمایش','active'=>'نمایش'], null, array('class' => 'form-control select2-show-search custom-select','required')) }}
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          {{Form::label('title1_'.$lang->lang, ' عنوان اصلی  *')}}
                          {{Form::text('title1_'.$lang->lang, null, array('class' => 'form-control','required'))}}
                        </div>
                      </div>
                      <div class="col-md-12 ">
                        <div class="form-group">
                          {{Form::label('text1_'.$lang->lang, 'متن عنوان اصلی ')}}
                          {{Form::textarea('text1_'.$lang->lang,null, array('class' =>  'form-control textarea_'.$lang->align))}}
                        </div>
                      </div>
                      {{-- <div class="col-md-12">
                        <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select name="operation_cat_id" class="form-control select2-show-search brand-select"
                  ...
                  @foreach($operationCats as $key=>$operationCat)
                    <option value="{{$operationCat->id}}">{{$operationCat->title}} {{$operationCat->col_name('title')}}</option>
                  @endforeach
                </select>
              </div>
            </div>
