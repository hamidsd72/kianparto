  ...
  <div class="row mt-5">
    <div class="col-xl-12 col-md-12 col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          {{ Form::open(array('route' => 'admin.operation-slider.store', 'method' => 'POST','id'=>'form_req','files'=>true)) }}
          <div class="row">
            <nav class="w-100">
                ...
                <div class="tab-pane fade {{$lang->align=='ltr'?'ltr_tab':''}}" id="nav-{{$lang->lang}}" role="tabpanel"
                  ...
                  <div class="container-fluid">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          {{Form::label('title1_'.$lang->lang, ' عنوان اصلی (bold) *')}}
                          {{Form::text('title1_'.$lang->lang, null, array('class' => 'form-control','required'))}}
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          {{Form::label('title2_'.$lang->lang, ' عنوان نارنجی(#)')}}
                          {{Form::text('title2_'.$lang->lang, null, array('class' => 'form-control','required'))}}
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          {{Form::label('text_'.$lang->lang, 'متن')}}
                          {{Form::textarea('text_'.$lang->lang, null, array('class' =>  'form-control textarea_'.$lang->align,'required'))}}
                        </div>
                      </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                {{Form::label('operation_cat_id', 'عمل جراحی *')}}
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                {{Form::number('sort',$sort, array('class' => 'form-control d-ltr text-left'))}}
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
